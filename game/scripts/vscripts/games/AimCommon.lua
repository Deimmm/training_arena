...
function AimCommon.prototype.finish(self)
    self.isGameRunning = false
    local ____ = self.obsSpawn and self.obsSpawn:kill()
    self.result = 0
    self.streak = 0
    self.avgTime = 0
    self.maxStreak = 0
