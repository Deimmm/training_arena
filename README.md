...
Creatye script nodejs which will iterate over models and create JSON with all existing models per hero name. Goal to create map
HERO_KEY: ALL CACHE DATA. To precache data by hero on selection and have single place whith all hero data.

How to create HERO TABLE

1. Download Sorce2Viewer
2. Find pak01_dir.vpk
3. Extract models/heroes models/items in dota_dist folder
4. Run heroTableBase.ts
